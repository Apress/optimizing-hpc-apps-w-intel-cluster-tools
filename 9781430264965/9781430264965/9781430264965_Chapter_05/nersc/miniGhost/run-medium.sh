...
mpirun -genv I_MPI_STATS ipm -n 8 ./miniGhost.x --scaling 1 --nx 200 --ny 200 --nz 200 --num_vars 40 --num_spikes 1 --debug_grid 1 --report_diffusion 21 --percent_sum 100 --num_tsteps 20 --stencil 24 --comm_method 10 --report_perf 1 --npx 2 --npy 2 --npz 2 --error_tol 8

mv results.yaml results-medium.yaml
mv results.txt results-medium.txt
